...
const Navbar = () => {
  ...
  return (
    <>
    <nav className=' bg-blue-600 flex  items-center justify-between  p-4 w-[100vw] h-[25vh] sm:flex '>
    ...
    {showMenu ? <FaAlignJustify className='size-10 absolute right-5 top-5'/> : <FaX className='size-10 mr-3 absolute right-5 top-5'/>}
      ...
      <div className={`${showMenu ? 'hidden' : 'block mr-10'} sm:block sm:flex sm:items-center `} >
              <ul className='sm:flex sm:flex-row sm:space-x-5'>
                  <li >
                      <Link to="/" className='text-base text-white font-medium sm:text-lg'>Home</Link>
                    
                  </li>
                  <li>
                      <Link to="/basics" className='text-base text-white font-medium sm:text-lg'>Basics</Link>
                    
                  </li>
                  <li>
                      <Link to="/lesson plan" className='text-base text-white font-medium sm:text-lg'>Lesson Plan</Link>
                      
                  </li>
                  <li>
                      <Link to="/contact" className='text-base text-white font-medium sm:text-lg'>Contact</Link>
                      
                  </li>
                  <li>
                      <Link to="/signup" className=' bg-red-200 text-base color-black text-white font-medium  inline-block py-2 px-4 sm:text-base '>Sign up</Link>
